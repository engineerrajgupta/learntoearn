...
<body class="bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 flex flex-col h-screen overflow-hidden">
    ...
    if (message) {
        ...
        const finalPrompt = "give me a quick revision with some examples including real life  on topic " + message;
        ...
        .finally(() => {
            ...
            messageInput.addEventListener('keydown', (event) => {
             ...
             window.addEventListener('load', () => {
                 setTimeout(() => {
                     addMessage("Hello! 👋  just type your topic here.. get quick revision ", false, true);
